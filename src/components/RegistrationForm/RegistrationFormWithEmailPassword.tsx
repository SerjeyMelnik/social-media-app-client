...
import {createUserWithEmailAndPasswordHandler} from '../../firebase/createUser';
...
const RegistrationFormWithEmailPassword: FC<TRegistrationFormWithEmailPassword> = ({setAuthMethod}) => {
